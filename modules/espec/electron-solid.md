...
An important asymmetry follows from the escape physics: X-rays escape from nearly the full micrometer-scale interaction volume, but signal electrons escape only from the top few nanometers. The same event generates both; what you detect determines what depth you sample, a sentence that summarizes half of this course.
