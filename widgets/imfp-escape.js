...
<div class="w-wrap">
  ...
  function draw() {
    ...
    // ---- universal curve, log-log ----
    {
      ...
      // technique bands
      g.fillStyle = isD ? "rgba(255,63,63,0.10)" : "rgba(204,0,0,0.06)";
